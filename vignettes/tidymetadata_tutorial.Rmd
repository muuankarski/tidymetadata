...
library(knitr)
opts_chunk$set(list(echo=FALSE,eval=TRUE,cache=FALSE,warning=FALSE,message=FALSE, fig.height=3, fig.width=5))
```
...
Again, this approach is very useful when working with shiny-applications as pointed out in this example at <https://github.com/muuankarski/tidymetadata/inst/shiny-examples/lisapp> that can be lauched with `tidymetadata::runExample()`
